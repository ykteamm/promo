    ...
    <div class="row" style="flex-wrap: inherit">
        ...
        <div class="col-md-4">
            <div class="input-group">
                <input type="text" value="{{number_format(Auth::user()->account,0,',',' ')}}" class="form-control" disabled style="border-top-right-radius: 18px !important;border-bottom-right-radius: 18px !important;height: calc(1.5em + 0.75rem + -6px);">
